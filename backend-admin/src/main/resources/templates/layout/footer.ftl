<footer>
    <div class="pull-right">
        Copyright © 2018 <a href="htts://www.xiang7.net" target="_blank">ZhangPeng</a> · Powered by <a href="https://gitee.com/ZhangPeng/DBlog" title="DBlog是一款简洁美观、自适应的Java博客系统..." target="_blank"><strong>DBlog</strong></a>. All Rights Reserved. Current version is 1.0.
    </div>
